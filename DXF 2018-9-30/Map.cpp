...
VOID Map::PickUpAllLoot(void (*PickUpFunction)(ObjectInfo))
{
	DWORD MapStartAddress = GetMapStartAddress();
	DWORD MapObjectCount = GetMapObjectCount(MapStartAddress);
	ObjectInfo _ObjectInfo;
...
vector<ObjectInfo> Map::SortByDistance(vector<ObjectInfo> Objects)
{
	ObjectInfo temp_var;
...
VOID Map::AttackMonster(void(*AttackFunction)(ObjectInfo))
{
	DWORD MapStartAddress = GetMapStartAddress();
	DWORD MapObjectCount = GetMapObjectCount(MapStartAddress);
